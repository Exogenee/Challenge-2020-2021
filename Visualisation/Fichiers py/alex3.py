...
#         points[0] = points[1]
#         points[1] = a
#         folium.CircleMarker(radius=data[l]['intensity'][k]/50, location=points, color="#3186cc", fill=True, fill_color="#3186cc", popup=f"Intensité:{data[l]['intensity'][k]} Jour:{str(data[l]['date'][k])[0:10]}").add_to(Montpellier[k])
#         #folium.CircleMarker(radius=data[l]['intensity'][k]/50, location=points, color="red", fill=True, fill_color="#3186cc", popup=f"Intensity:{data[l]['intensity'][k]} Day:{str(data[l]['date'][k])[0:10]}").add_to(Montpellier[k])
